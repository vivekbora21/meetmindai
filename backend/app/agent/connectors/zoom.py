...
class ZoomConnector(MeetingConnector):
    """
    Zoom Connector. Integrates with Zoom SDK API endpoints.
    """
    ...
    def join_meeting(
        ...
        logger.info(f"[ZoomConnector] Connected to Zoom meeting: {meeting_url}")

    def leave_meeting(self) -> None:
        self.is_connected = False
        logger.info("[ZoomConnector] Left Zoom call.")
