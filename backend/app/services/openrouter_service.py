...
class OpenRouterService:
    ...
    def extract_meeting_insights(self, transcript_text: str) -> Dict[str, Any]:
        logger.info("OpenRouterService | Delegating extract_meeting_insights to GeminiService.")
    ...
    def diarize_transcript(
        ...
        logger.info("OpenRouterService | Delegating diarize_transcript to GeminiService.")
    ...
    def generate_answer_stream(
        ...
        logger.info("OpenRouterService | Delegating generate_answer_stream to GeminiService.")
    ...
    def generate_chat_title(self, question: str) -> str:
        logger.info("OpenRouterService | Delegating generate_chat_title to GeminiService.")
