...
def upgrade() -> None:
    ...
    op.create_index('idx_microsoft_accounts_graph_user_id', 'microsoft_accounts', ['graph_user_id'], unique=False)


def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index('idx_microsoft_accounts_graph_user_id', table_name='microsoft_accounts')
