...
def upgrade() -> None:
    ...
    op.add_column(
        "meetings", sa.Column("provider", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "meetings",
    ...
    op.add_column(
        "meetings", sa.Column("provider_event_id", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "meetings", sa.Column("calendar_id", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "meetings", sa.Column("organizer_email", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "meetings", sa.Column("sync_status", sa.String(length=50), nullable=True)
    )
    ...
    op.add_column(
        "meetings", sa.Column("token_reference", sa.String(length=255), nullable=True)
    )
    ...
    op.add_column(
        "connected_accounts", sa.Column("scope", sa.String(length=500), nullable=True)
    )
    op.add_column(
        "connected_accounts",
        sa.Column(
